...
const areas = {
  ...
  kropp: { eyebrow: "Följ", title: "Kropp", description: "Vikt, mått, bilder och prestation samlas här så att vågen aldrig behöver bära hela berättelsen.", primaryLabel: "Logga mätning", features: [{ title: "Vikt och milstolpar", detail: "Följ riktningen mot 100 kg med spårbara datapunkter." }, { title: "Kroppsmått", detail: "Midja, bröst, armar, lår och egna valfria mått." }, { title: "Före och efter", detail: "Privata bilder i samma vinkel med kontrollerad jämförelse." }], nextSteps: ["Införa vikt och kroppsmått", "Bygga jämförelsevyn", "Koppla milstolpar till bilderna"] },
