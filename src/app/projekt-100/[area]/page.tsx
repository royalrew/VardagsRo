...
const areas = {
  traning: { eyebrow: "Bygg", title: "Träning", description: "Planera, genomför och förstå varje pass — hemma, i skogen, på utegymmet, på cykeln eller i löpspåret.", primaryLabel: "Starta pass", features: [{ title: "Dagens pass", detail: "Ett tydligt fokus utan att resten av historiken tar plats." }, { title: "Passmallar", detail: "Återanvänd upplägg som fungerar i din verkliga vardag." }, { title: "Historik och rekord", detail: "Volym, distans, tid och personbästa på egna detaljsidor." }], nextSteps: ["Definiera träningspass och övningar", "Bygga passmallar", "Koppla planering till jobbveckan"] },
